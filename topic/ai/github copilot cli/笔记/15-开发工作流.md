...
一份高质量的 AI 计划书应包含以下要素——你可以把它理解为 AI 版的"技术方案评审[[文档"]]：
...
AI 擅长快速定位[[常见错误]]模式——把错误信息或日志贴给它，通常能比搜索引擎更快地找到原因。但对于复杂的系统级问题（如并发竞态），AI 的建议可能不够深入，此时还需要结合实际调试工具。
...
**~/.copilot/settings.json 或 .github/copilot/settings.json**
