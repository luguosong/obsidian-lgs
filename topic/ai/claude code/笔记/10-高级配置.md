...
**statusline.sh — 无 jq 的 Git Bash 版本**
...
| `CLAUDE_CODE_PERFORCE_MODE` | Perforce 模式：只读[[文件操作]]提示 `p4 edit` 而非静默覆盖（v2.1.98 新增） | `1` |
