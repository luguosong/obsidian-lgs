---
title: "caozhiyuan/copilot-api: OpenAI and Anthropic-compatible gateway for GitHub Copilot or third-party providers. Please read README.md completely before use!"
source: "https://github.com/caozhiyuan/copilot-api/blob/dev/README.zh-CN.md"
description: "OpenAI and Anthropic-compatible gateway for GitHub Copilot or third-party providers. Please read README.md completely before use! - caozhiyuan/copilot-api"
author:
published:
---
字数：7968
...
[英文](https://github.com/caozhiyuan/copilot-api/blob/dev/README.md) | 简体中文
...
[https://github.com/caozhiyuan/copilot-api/releases](https://github.com/caozhiyuan/copilot-api/releases)
...
[![Copilot API 桌面应用首页](https://github.com/caozhiyuan/copilot-api/raw/dev/docs/screenshots/desktop-dashboard.png)](https://github.com/caozhiyuan/copilot-api/blob/dev/docs/screenshots/desktop-dashboard.png) [![Copilot API 桌面应用 Token 用量页](https://github.com/caozhiyuan/copilot-api/raw/dev/docs/screenshots/desktop-token-usage.png)](https://github.com/caozhiyuan/copilot-api/blob/dev/docs/screenshots/desktop-token-usage.png)
...
> **注意：** GitHub token 及相关数据会保存在宿主机的 `copilot-data` 目录中。该目录会映射到容器内的 `/root/.local/share/copilot-api` ，从而在容器重启后继续保留数据。
...
[![Copilot API Usage Viewer 页面](https://github.com/caozhiyuan/copilot-api/raw/dev/docs/screenshots/usage-viewer.png)](https://github.com/caozhiyuan/copilot-api/blob/dev/docs/screenshots/usage-viewer.png)
