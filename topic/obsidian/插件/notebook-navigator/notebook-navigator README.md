...
- **[[更新日志]]弹窗（更新时/手动打开时）：** 从 `https://raw.githubusercontent.com/johansan/notebook-navigator/main/images/version-banners/<id>.jpg` 加载版本横幅图片，用于包含横幅的更新说明。
- **[[更新日志]]弹窗（更新时/手动打开时）：** 从 `https://img.youtube.com/vi/<id>/...` 加载 YouTube 缩略图，用于包含 YouTube 链接的更新说明。
