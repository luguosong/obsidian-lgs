...
**.git/hooks/pre-commit 示例：ESLint + Prettier**
...
**.git/hooks/commit-msg 示例：Conventional Commits 格式验证**
...
**.git/hooks/prepare-commit-msg 示例：自动填入分支名**
