...
**安装 Nginx（RHEL/CentOS/AlmaLinux）**
...
**/etc/apache2/sites-available/mysite.conf（VirtualHost 示例）**
...
**httpd.conf / apache2.conf —— Apache 隐藏版本**
