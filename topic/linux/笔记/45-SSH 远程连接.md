...
> [!tip] 非[[对称加密]] vs 会话密钥
>
> 非[[对称加密]]计算量大，不适合持续传输大量数据。因此 SSH 只用非[[对称加密]]来**协商**一个临时的对称会话密钥（如 AES），后续通信全部使用这个会话密钥加密，兼顾安全与性能。
...
**RHEL/CentOS/Fedora 安装并启动 SSH 服务**
